...
def main_part2__LONs(instances_foldername, lons_foldername, metrics_foldername, K):
    for filename in os.listdir(instances_foldername):
        ...
        L, E, best_path_length, best_path, successes, mean_iters = generate_LON(A, 100, 100, K)
...
# main_part2__LONs("data_bays29", "checking2/1_lons", "checking2/3_performance_metrics", 1)
# main_part3__LON_images("1_bays29_1000/1_lons", "1_bays29_1000/2_images")
# main_part4__metrics("best", "checking2/1_lons", "checking2/3_performance_metrics", "checking2/4_network_metrics")
